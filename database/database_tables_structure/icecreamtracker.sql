    ...
    ALTER SCHEMA tracker OWNER TO pg_database_owner;
    ...
    ALTER TABLE tracker."Customer" OWNER TO postgres;
    ...
    ALTER TABLE tracker."Employee" OWNER TO postgres;
    ...
    ALTER TABLE tracker."Inventory" OWNER TO postgres;
    ...
    ALTER SEQUENCE tracker."Inventory_id_seq" OWNER TO postgres;
    ...
    ALTER TABLE tracker."Order" OWNER TO postgres;
    ...
    ALTER TABLE tracker.ticket OWNER TO postgres;
